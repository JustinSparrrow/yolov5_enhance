...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=0.5, max_rotation_angle=5,
                 crop_rate=0.5, shift_rate=0.5, change_light_rate=0,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='./cowandetu_xml')
    parser.add_argument('--source_xml_path', type=str, default='./xml')
    parser.add_argument('--save_img_path', type=str, default='./final_img')
    parser.add_argument('--save_xml_path', type=str, default='./final_xml')
